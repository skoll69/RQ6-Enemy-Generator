...
from models import MWEnemyTemplate, _Enemy, Ruleset, StatAbstract, Race, SpellAbstract
...
class TestEnemyTemplate(TestCase):
    ...
    def test_01_create(self):
        ...
        et = MWEnemyTemplate.create(user, ruleset, race, 'Template Name')
...
def get_enemy_template():
    ...
    et = MWEnemyTemplate.create(user, ruleset, race, 'Test Template')
    return et
